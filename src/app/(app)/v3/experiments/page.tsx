import ExperimentsView from "../../v2/experiments/ExperimentsView";
import { createServerClient } from "@/lib/supabase";
import { parseExperimentRow, ExperimentRow } from "@/lib/v2/parsers";
...
export default async function V3ExperimentsPage() {
